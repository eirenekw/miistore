...
<head>
	...
	<title>MiiStore | Statistika Total Pendapatan per Hari</title>
				...
				<div class="row">
					<div class="col-lg-12" style="margin-bottom: 8%;">
						...
						<div class="chartjs">
							...
							$query = "SELECT o1.day, COALESCE(o2.amount,0) AS totalamount
										  FROM
											  ...
											  LEFT JOIN (SELECT DATE_FORMAT(orders.creation_date,'%d') AS day, 
											  ...
											  WHERE MONTH(orders.creation_date) = MONTH(CURRENT_DATE)
											  GROUP BY DATE_FORMAT(orders.creation_date,'%d')) o2 ON o2.day = o1.day 
											  GROUP BY o1.day DESC";
								...
								$(document).ready(function() {
									...
									var myChart = new Chart(ctx, {
										...
										options: {
											...
											title: {
												display: true,
												text: 'Statistika Total Pemesanan per Hari'
											},
											scales: {
												yAxes: [
													{

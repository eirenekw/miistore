...
<head>
	...
	<title>MiiStore | Laporan Data Produk</title>
	...
	<div id="wrapper">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i> Laporan <i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						<li class="active"><a href="item_report.php">Laporan Data Produk</a></li>
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<button type="button" class="btn btn-default" onclick="window.open('pdf/item_report_bypdf.php');"> Lihat PDF</button>
